...
const generated = path.join(root, 'src', 'app', 'generated', 'subscription-api');
...
if (fs.existsSync(apiDir)) {
  for (const file of fs.readdirSync(apiDir)) {
    ...
    content = content
      ...
      .replace(/from\s+['"]\.\.\/(.+?)['"]/g, "from '../generated/subscription-api/$1'");
...
if (movedCount === 0) {
  console.log('  No generated files found — did you run generate:client:subscription first?');
} else {
